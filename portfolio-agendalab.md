...
[![Requisitos do Sistema - AgendaLab](evidencias/Requisitos.png)](evidencias/Requisitos.png)
...
* **Status:** 🟢 Aprovado
* **Resultado Esperado:** O sistema deve bloquear a confirmation do agendamento para períodos passados, retornando um alerta restritivo.
...
> **Obs:** Recomenda-se ajustar o campo para aplicar a máscara de formatação automaticamente conforme os números são digitados. Isso elimina a necessidade de o usuário inserir caracteres especiais manualmente e evita o estouro do limite máximo de dígitos.
