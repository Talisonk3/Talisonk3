...
•	Resultado obtido: O sistema permitiu a inserção de caracteres numéricos, especiais e espaço no início do campo e a confirmação do agendamento mesmo como campo com esses caracteres.
